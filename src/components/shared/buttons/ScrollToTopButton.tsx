      ...
      <button
        ...
        className={`${
          isVisible ? "block" : "hidden"
                ...
                tab:size-20 rounded-full border-[1px] tab:border-[2px] border-blue before:content-[''] before:absolute before:-z-10 
                ...
                before:duration-300 before:ease-out active:before:opacity-100 focus-visible:before:opacity-100 hover:before:opacity-100 
                outline-none`}
        onClick={scrollToTop}
      >
        <Image
