...
export default function CookiesComponent() {
  ...
  return (
    <div
      className={`fixed z-20 left-0 bottom-0 flex items-center justify-center w-full max-h-[300px] tablet:max-h-[168px] laptop:max-h-[155px]
       py-10 px-4 tab:px-9 laptop:px-[100px] bg-backgroundLight ${
      ...
      <div className="flex flex-col gap-y-8 tab:gap-y-0 items-start tab:flex-row tab:items-center tab:justify-between max-w-[1720px]">
        <p className="tab:w-[65.2%] laptop:w-[74.6%]">
          ...
          <Link
            ...
            target="_blank"
            locale={locale}
            className="outline-none border-b text-blue border-blue laptop:hover:text-blueLight laptop:hover:border-blueLight 
          laptop:focus-visible:text-blueLight laptop:focus-visible:border-blueLight transition duration-300 ease-out"
          >
            {t("cookies.policy")}
          </Link>
          .
