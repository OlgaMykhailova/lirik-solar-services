...
export default function Hero() {
  ...
  return (
    <section className="h-[618px] tab:h-[728px] pt-6 laptop:pt-16 laptop:pb-[90px] bg-headerGradient">
      <Container className="relative">
        ...
        <span
          className="absolute z-10 left-[172px] tab:left-[356px] laptop:left-[456px] top-[176px] tab:top-[259px] laptop:top-[300px] inline-block px-4 tab:px-[38px] laptop:px-[50px] align-text-top font-gogh text-lg tab:text-xxl laptop:text-xxxl text-blue 
